...
it("Should mount & unmount children components", async () => {
  ...
  expect(homePage.root.getAttribute("data-id")).toBeDefined()
  expect(homePage.button.root.getAttribute("data-id")).toBeDefined()
  expect(homePage.button.label.root.getAttribute("data-id")).toBeDefined()
